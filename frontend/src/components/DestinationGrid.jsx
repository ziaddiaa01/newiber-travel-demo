  ...
  return (
    <section className="w-full px-4 py-20 sm:px-8 lg:px-16">
      <div className="mx-auto max-w-7xl">
        ...
        {/* Grid
            mobile  → 1 col, fixed card height
            tablet  → 2 cols, fixed card height
            desktop → 4 cols, auto-rows:220px so row-span-N cards get N×220px
        */}
        <div
          ...
          {destinations.map((dest, idx) => (
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 z-10 p-5
                              ...
                              ease-[cubic-bezier(.22,1,.36,1)]">
                <svg className="h-3.5 w-3.5 text-white/80 flex-shrink-0"
